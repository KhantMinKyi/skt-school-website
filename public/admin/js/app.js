(function () {
    ...
    makeArray(document.querySelectorAll(".animated-icon > div")).forEach(
        function (icon) {
    ...
    // Sidebar navigation
    makeArray(
        document.querySelectorAll(".sidebar-item > .nav-item > a")
        ...
        menuItem.addEventListener("click", function (e) {
            ...
            var otherCarets = makeArray(
                document.querySelectorAll(".caret")
            ).filter(function (otherCaret) {
    ...
    makeArray(document.querySelectorAll(".toggle-fullscreen")).forEach(
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        if (localStorage.getItem("darkMode") === "enabled") {
            page.classList.add("dark-mode");
            document.querySelector("#darkModeOption").checked = true; // Ensure the checkbox is checked
        } else {
            page.classList.remove("dark-mode");
            document.querySelector("#darkModeOption").checked = false; // Ensure the checkbox is unchecked
        }
    });
