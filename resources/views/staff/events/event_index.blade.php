...
@section('content')
    ...
    <div class="card">
        ...
        <div class="text-right m-4 ">
            ...
            <a href="{{ route('staff-events.show_archived_event') }}" class="btn btn-secondary btn-md">
                <div class="d-flex  align-items-center">
                    <span class="animated-icon mr-2 ">
                        <div style="width:14px;height:14px; cursor: pointer;"
            ...
            <a href="{{ route('staff-event-comments.index') }}" class="btn btn-primary btn-md position-relative">
                <div class="d-flex align-items-center">
                    <span class="animated-icon mr-2">
                        <div style="width:14px;height:14px; cursor: pointer;"
            ...
            <div class="modal-content">
                <form action="{{ route('staff-events.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <input type="hidden" name="event_branch_id" value="{{ $user->branch_id }}">
                            <div class="col-12">
                                <div class="row mb-3">
