            ...
            <div class="carousel-item active w-full flex-shrink-0">
                ...
                <div class="absolute inset-0 mx-auto flex flex-col justify-center items-center  ">
                    <h1 id="fading-text" class=" text-2xl md:text-7xl text-center  ml-10">
                        ...
                        <br>
                        <div class="text-white mt-4">{{ $event->event_title }} </div>
                    </h1>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-7 col-sm-12 col-xs-12 w-full lg:w-7/12">
                    ...
                    {{-- <div class="author_part mt-8 bg-gray-100 p-6 rounded-lg">
                        ...
                        <div class="single_author flex items-center gap-4">
                            <img src="{{ asset($event->event_banner) }}" class="w-16 h-16 rounded-full" alt="" />
                            <div>
                                <h4 class="text-lg font-semibold">{{ $event->created_user->name }}</h4>
