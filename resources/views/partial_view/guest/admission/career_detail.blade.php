            ...
            <div class="carousel-item active w-full flex-shrink-0">
                ...
                <div class="absolute inset-0 mx-auto flex flex-col justify-center items-center  ">
                    <h1 id="fading-text" class=" text-2xl md:text-7xl text-center  ml-10">
                        ...
                        <br>
                        <div class="text-white mt-4">{{ $job->career_job_title }} </div>
                    </h1>
                </div>
            </div>
        </div>
    ...
    <section>
        <div class="container mx-auto my-10">
            <div class="bg-white shadow-lg p-4 md:p-10 rounded-md">
                ...
                <h2 class=" font-bold text-2xl">{{ $job->career_job_title }}</h2>
                ...
                <div class="mt-10">
                    <p class="text-xl my-2">Open To</p>
                    <div class=" flex align-middle justify-start">
                        <i class="fa-solid fa-check text-2xl mr-4 text-teal-400"></i>
                        <p class="text-lg ">
                            {{ $job->career_job_gender }}
                        </p>
                    </div>
                    <p class="text-xl my-2">Employee Type</p>
                    <div class=" flex align-middle justify-start">
                        <i class="fa-solid fa-check text-2xl mr-4 text-teal-400"></i>
                        <p class="text-lg ">
                ...
                <h2 class=" font-bold text-2xl">{{ $job->branch->branch_name }} Offers You</h2>

                <div class="grid grid-cols-1 lg:grid-cols-3 mt-6 gap-10">
                    <div class="my-1  flex align-middle  justify-items-start shadow-xl p-4 roudned-lg">
                        <div class="hidden sm:block">
                            <i class="fa-solid fa-check text-2xl mr-4 text-teal-400 "></i>
                        </div>
                        <div class="ml-4  ">
