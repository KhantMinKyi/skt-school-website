    ...
    <div id="kenburns_061"
        ...
        <div class="carousel-inner flex transition-transform duration-1000 ease-in-out mt-[89px] sm:mt-0"
            ...
            <div class="carousel-item active w-full flex-shrink-0">
                <img src="{{ asset('img/banner/admission_banners/admission_process/' . $branch->branch_short_name . '.webp') }}"
            ...
            <div class="col-xs-12">
                <div class="pd_tab_area fix">
                    ...
                    <div role="tabpanel" class="tab-pane fade show tab-content text-sm md:text-base" id="tab1">
                        <p>We are excited that you are considering SKT International School Riverside Campus for your child.
                            We will support you throughout the admissions process and look forward to welcoming you to the
                            SKT International School Riverside Campus.

                            Students seeking registration at SKT International School Riverside Campus from Kindergarten to
                        ...
                        <p>After the application is submitted, a parent meeting and child assessment will be scheduled.
                            ...
                            School Riverside Campus admissions assessment, the Admissions Committee will make a decision on
                    ...
                    <div role="tabpanel" class="tab-pane fade tab-content hidden text-sm md:text-base" id="tab2">
                        <p>သင်၏ကလေးများအတွက် ကျွန်ုပ်တို့၏ SKT International School Riverside Campus ကိုစိတ်ဝင်စားသည့်အတွက်
                            စိတ်လှုပ်ရှားမိပါသည်။ ကျွန်ုပ်တို့သည် ကျောင်းဝင်ခွင့်လျှောက်လွှာတင်မှု တစ်လျှောက်လုံးတွင်
                            သင့်အားပံ့ပိုးပေးသွားမည်ဖြစ်ပြီးSKT International School Riverside Campus မှသင့်အား
                            ကြိုဆိုလျက်ရှိပါသည်။
                            SKT International School Riverside Campus တွင် တက်ရောက်လိုသော ကျောင်းသားကျောင်းသူများသည်
                        ...
                        <p>လျှောက်လွှာတင်ပြီးလျှင် မိဘနှင့်တွေ့ဆုံဆွေးနွေး၍ ကလေးအားအကဲဖြတ် ပါလိမ့်မည်။
                            SKT International School Riverside Campus ၏ကျောင်းဝင်ခွင့်အကဲဖြတ်ကော်မတီမှ ယခင်ပြီးခဲ့သည့်
                        ...
                        <p>ပိုမိုသိရှိလိုပါက ကျေးဇူးပြု၍ email (သို့မဟုတ်) ကျွန်ုပ်တို့၏ကျောင်းသားရေးရာဌာန <b> 019410010-20,
                                09424451186, 09978439824 </b> သို့ ဆက်သွယ်မေးမြန်းစုံစမ်းနိုင်ပါသည်။</p>
                    </div>
