...
@section('content')
    ...
    <div id="kenburns_061"
        ...
        <div class="carousel-inner flex transition-transform duration-1000 ease-in-out" id="carouselInner">
            ...
            <div class="carousel-item active w-full flex-shrink-0">
                <img src="{{ asset('img/banner/admission_banners/college_counseling_service/' . $branch->branch_short_name . '.jpg') }}"
                ...
                <div class="absolute inset-0 mx-auto flex flex-col justify-center items-center  ">
                    <h1 id="fading-text" class=" text-xl sm:text-5xl lg:text-7xl text-center  ml-10">
                        ...
                        <br>
                        <div class="text-white mt-4">College Counseling Service </div>
                    </h1>
                </div>
            </div>
        </div>
    ...
    <section class="topic_content_area section-padding" style="background-image: url(assets/images/banner/topic.png);">
        <div class="container mx-auto">
            ...
            <div class=" p-4">
                <h2 class="text-2xl font-bold py-4"> College Counseling Services</h2>
                <p class="text-lg">
            ...
            <div class=" p-4">
                <h2 class="text-2xl font-bold py-4"> Our Approach</h2>
                <p class="text-lg">
        ...
        <div class="container mx-auto p-4">
            ...
            <div class="grid md:grid-cols-2 my-5">
                <div class="my-5">
                    ...
                    <p class="p-1 font-semibold text-gray-800">Personalized sessions with our experienced counselors to
                ...
                <div class="my-5">
                    ...
                    <p class="p-1 font-semibold text-gray-800"> Guidance on researching and identifying colleges and
            ...
            <div class="grid md:grid-cols-2 my-5">
                <div class="my-5">
                    ...
                    <p class="p-1 font-semibold text-gray-800">Assistance with every step of the college application
                ...
                <div class="my-5">
                    ...
                    <p class="p-1 font-semibold text-gray-800"> Expert advice on crafting compelling personal statements and
            ...
            <div class="grid md:grid-cols-2 my-5">
                <div class="my-5">
                    ...
                    <p class="p-1 font-semibold text-gray-800">Counseling on the best approach to standardized tests (SAT,
                ...
                <div class="my-5">
                    ...
                    <p class="p-1 font-semibold text-gray-800"> Mock interviews and coaching to help students feel confident
    ...
    <div class="container mx-auto">
        ...
        <div class=" p-4">
            <h2 class="text-2xl font-bold py-4"> Building Futures, Together</h2>
            <p class="text-lg">
