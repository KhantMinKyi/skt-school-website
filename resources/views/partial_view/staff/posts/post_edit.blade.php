...
@section('content')
    <div class="card">
        ...
        <form action="{{ route('staff-posts.update', $post->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="card-body">
                <div class="row">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-9">
                                <textarea class="form-control" name="post_body" id="" cols="30" rows="5" required
                                    placeholder="Enter Post Body ">{{ $post->post_body }}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
                ...
                <div class="text-right">
                    <a href="{{ route('staff-posts.index') }}" class="btn btn-light" data-bs-dismiss="modal">
                        Close
                    </a>
