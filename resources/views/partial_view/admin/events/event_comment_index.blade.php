...
@section('content')
    ...
    <div class="d-flex justify-content-end m-4 ">
        <a href="{{ route('admin-events.index') }}" class="animated-icon d-flex justify-content-center align-items-center">
                                ...
                                <tr>
                                    ...
                                    <td class="">
                                        <div class="d-flex justify-content-center align-items-center">
                                            <form action="{{ route('admin-event-comments.change_comment_status') }}"
                                                method="post">
                                                @csrf
                                                @method('PUT')
                                            ...
                                            <form action="{{ route('admin-event-comments.destroy', $comment->id) }}"
