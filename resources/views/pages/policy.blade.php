@extends($layout)
@section('content')
    <section class="mt-[89px] container mx-auto text-gray-950 p-4">
        <h1 class="text-2xl md:text-3xl font-bold">Privacy Policy</h1>
        <p class="my-1">Last updated: May 02, 2025</p>
        <p>This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your
            information
            when You use the Service and tells You about Your privacy rights and how the law protects You.</p>
        <h2 class="text-xl md:text-2xl font-semibold mt-2 mb-1 ">Interpretation and Definitions</h2>
        <h3 class="text-lg md:text-xl font-semibold mt-2 mb-1">Interpretation</h3>
        <p>The words of which the initial letter is capitalized have meanings defined under the following conditions. The
            following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
        </p>
        <h3 class="text-lg md:text-xl font-semibold mt-2 mb-1">Definitions</h3>
        ...
        <ul class=" list-disc list-inside text-gray-700 space-y-2">
            ...
            <li>
                ...
                or
                &quot;Our&quot; in this Agreement) refers to BFI EDUCATION SERVICES COMPANY LIMITED, Shukhinthar Mayopat
                Road, Yangon.
            </li>
            <li>
            ...
            <li>
                <strong>Website</strong> refers to SKT International School, accessible from <a href="https://skt.edu.mm/"
                    rel="external nofollow noopener" target="_blank">https://skt.edu.mm/</a>
            </li>
            <li>
        ...
        <h2 class="text-xl md:text-2xl font-semibold mt-2 mb-1 ">Collecting and Using Your Personal Data</h2>
        <h3 class="text-lg md:text-xl font-semibold">Types of Data Collected</h3>
        <h4 class="text-base md:text-lg my-1 font-semibold">Personal Data</h4>
        ...
        <h4 class="text-base md:text-lg my-1 font-semibold">Usage Data</h4>
        ...
        <h4 class="text-base md:text-lg my-1 font-semibold">Tracking Technologies and Cookies</h4>
        ...
        <ul class=" list-disc list-inside text-gray-700 space-y-2">
            <li>
                ...
                use
                these Cookies to provide You with those services. <br>
            </li>
            <li>
        ...
        <h3 class="text-lg md:text-xl font-semibold mt-2 mb-1">Use of Your Personal Data</h3>
        ...
        <ul class=" list-disc list-inside text-gray-700 space-y-2">
            ...
            <li>
                <strong>To respond to Your inquiries:</strong> To process and respond to your inquiries and requests
                submitted through our contact forms or comment forms.<br>
            </li>
            <li>
            ...
            <li>
                ...
                which
                Personal Data held by Us about our Service users is among the assets transferred.<br>
            </li>
            <li>
        ...
        <h3 class="text-lg md:text-xl font-semibold mt-2 mb-1">Retention of Your Personal Data</h3>
        ...
        <h3 class="text-lg md:text-xl font-semibold mt-2 mb-1">Transfer of Your Personal Data</h3>
        ...
        <h3 class="text-lg md:text-xl font-semibold mt-2 mb-1">Delete Your Personal Data</h3>
        <p>You have the right to delete or request that We assist in deleting the Personal Data that We have collected about
            You.</p>
        <p>If You have provided Personal Data through our contact forms or comment forms and would like it to be deleted,
            please contact us using the information provided in the "Contact Us" section of this Privacy Policy.</p>
        <p>Please note, however, that We may need to retain certain information when we have a legal obligation or lawful
            basis
            to do so.</p>
        <h3 class="text-lg md:text-xl font-semibold mt-2 mb-1">Disclosure of Your Personal Data</h3>
        <h4 class="text-base md:text-lg my-1 font-semibold">Business Transactions</h4>
        ...
        <h4 class="text-base md:text-lg my-1 font-semibold">Law enforcement</h4>
        ...
        <h4 class="text-base md:text-lg my-1 font-semibold">Other legal requirements</h4>
        ...
        <h3 class="text-lg md:text-xl font-semibold mt-2 mb-1">Security of Your Personal Data</h3>
        <p>The security of Your Personal Data is important to Us, but remember that no method of transmission over the
            Internet,
            or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect
            Your
            Personal Data, We cannot guarantee its absolute security.</p>
        <h2 class="text-xl md:text-2xl font-semibold mt-2 mb-1 ">Children's Privacy</h2>
        ...
        <h2 class="text-xl md:text-2xl font-semibold mt-2 mb-1 ">Links to Other Websites</h2>
        ...
        <h2 class="text-xl md:text-2xl font-semibold mt-2 mb-1 ">Changes to this Privacy Policy</h2>
        ...
        <h2 class="text-xl md:text-2xl font-semibold mt-2 mb-1 ">Contact Us</h2>
