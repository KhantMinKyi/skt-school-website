...
@section('content')
                    ...
                    <p class=" text-gray-500">
                        @isset($branch->history)
                            ...
                            <a href="{{ route('our-history.home', $branch->branch_short_name) }}"
                                class="text-teal-500 hover:xltext-teal-700">See More</a>
                        @endisset
                    </p>
                </div>
    ...
    <section id="" class=" mt-10  mb-10">
        <div class="container  mx-auto">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 text-center mt-4">
                {{-- card --}}
        ...
        <div class="container mx-auto px-4">
            <div class="relative h-[500px] shadow-md">
                ...
                <div class="absolute  w-full md:w-[100%] h-[100%]">
                    <img src="{{ asset('img/banner/student_life_banners/news/SKT-CC.jpg') }}" alt="School Campus"
