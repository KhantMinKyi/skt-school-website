...
<html lang="en">
	<head>
		...
		<meta name="description" content="SKT International School">
			...
			<div class="row">
				<div class="col-lg-4 col-md-3 col-sm-4 text-center">
					<div class="site-logo">
						...
						<a href="/"><img src="img/skt_logo2.png" alt=""></a>	        				
					</div>
				</div><!--- END Col -->
			...
			<div class="row">
				<div class="col-lg-6 col-md-5 col-sm-6 col-xs-12">	
					<div class="home_content">
						<h1> <span> INSPIRING BRILLIANCE</span> BUILDING BRIGHTER FUTURES</h1>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 text-center">
					...
					<div class="partner">
						<a href="#"><img src="img/sister-schools/skt_riverside_campus.png" width="140px" alt="image"></a>
						<a href="#"><img src="img/sister-schools/skt_city_campus.png" width="140px" alt="image"></a>
        ...
        (entries) => {
            entries.forEach((entry) => {
                if (entry.isIntersecting) {
                    ...
                    // When the element is out of view, slide out
