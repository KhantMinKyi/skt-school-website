                    ...
                    <ul class="d-block scroll-y flex-1 py-3 nav flex-column">
                        ...
                        <div class="sidebar-item">
                            <li class="nav-item ">
                                ...
                                <div class="sub-menu collapse {{ request()->routeIs('staff-categories.index') ? 'show' : '' }}"
                                    aria-expanded="{{ request()->routeIs('staff-categories.index') ? 'true' : 'false' }}">
                                    <ul class="nav flex-column">
                                        <li
                                            class="nav-item {{ request()->routeIs('staff-categories.index') ? 'active' : '' }}">
                                            <a href="{{ route('staff-categories.index') }}" class="nav-link">
                                                <span class="animated-icon">
                                                    <div style="width:18px;height:18px"
                        ...
                        <div class="sidebar-item">
                            <li class="nav-item {{ request()->routeIs('staff-contacts.index') ? 'active' : '' }}">
                                <a class="nav-link d-flex align-items-center nav-link"
                                    href="{{ route('staff-contacts.index') }}">
                                    <span class="animated-icon">
                                        <div style="width:18px;height:18px"
                                            data-animation-path="{{ asset('admin/vendor/animated-icons/document/document.json') }}"
                                            data-anim-loop="false"></div>
